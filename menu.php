...
<html>
    ...
    <body style="background-image: url(back.jpg);margin-left: 20%; margin-right: 20%; display: block; justify-content: center;align-items: center;">
          ...
          <button class="btn" id="openCreate"> Создать</button>
    ...
    <?php if ($result) {
        ...
        foreach ($result as $row) { ?>
           <tbody>
            ...
            <td>  <button id="openEdit<?php echo htmlspecialchars($row['id'])?>"> Редактировать</button> <button class="buttonz" id="openDelete<?php echo htmlspecialchars($row['id'])?>">Удалить</button> </td>
            </tr>
